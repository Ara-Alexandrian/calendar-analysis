...
def normalize_personnel(llm_processed_df): # Removed normalizer_fn argument
    """
    Normalize extracted personnel names using NormalizationService.
    ...
    try:
        ...
        # Instantiate and use the NormalizationService
        normalization_service = NormalizationService()
        normalized_df = normalization_service.normalize_extracted_personnel(llm_processed_df)
