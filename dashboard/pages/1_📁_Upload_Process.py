...
from dashboard.components.upload_process import ui_components, db_operations, llm_processing, data_processing # Updated import path
        ...
        if st.session_state.raw_df is not None:
            ...
            with st.spinner("Processing data... This may take a while for the initial steps."):
                try:
                    ...
                    normalized_df = data_processing.normalize_personnel( # Removed first argument
                        llm_processed_df
                    )
